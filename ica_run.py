...
# we have cum of shape 202, 268, 327 and mask tif. We want to mask cum with mask tif i.e. make 
# pixels in cum nan where mask_tif = 0. NaNs are where no data e.g. outside of frame, low coh...
